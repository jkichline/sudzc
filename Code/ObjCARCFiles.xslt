...
<xsl:stylesheet version="1.0"
    ...
    <xsl:variable name="templateName">ObjCARCFiles</xsl:variable>
    ...
    <xsl:template match="wsdl:definitions">
        <package class="{$shortns}{$serviceName}">
            ...
            <folder copy="ObjCARC/Documentation"/>
            <folder copy="ObjCARC/Examples"/>
...
+ (NSString *)prefix
{
    return @"</xsl:text><xsl:value-of select="$shortns"/><xsl:text>";
}
