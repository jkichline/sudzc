...
@interface <xsl:value-of select="$shortns"/><xsl:value-of select="$serviceName"/>Example : NSObject* {
		...
		<file>
			<xsl:attribute name="filename">Examples/<xsl:value-of select="$shortns"/><xsl:value-of select="$serviceName"/>Example.m</xsl:attribute>#import "<xsl:value-of select="$shortns"/><xsl:value-of select="$serviceName"/>Example.h"
